...
{
    options.UseSqlServer("Server=localhost;Database=Warehouse;Trusted_Connection=True;TrustServerCertificate=True;");
    //options.UseSqlServer("localhost;Database=Warehouse;Trusted_Connection=True;TrustServerCertificate=True;");
});
